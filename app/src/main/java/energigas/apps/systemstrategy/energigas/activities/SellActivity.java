...
public class SellActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener, SugarTransactionHelper.Callback, ExportObjectsListener {
    ...
    private Almacen almacenCliente;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        almacenCliente = Almacen.find(Almacen.class," establecimiento_Id=?",  new String[]{Session.getSessionEstablecimiento(this).getEstIEstablecimientoId() + ""}).get(Constants.CURRENT);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                     ...
                     PedidoDetalle pedidoDetalle = PedidoDetalle.getPedidoDetalleByPedido(pedido.getPeId() + "").get(0);
                       ...
                       double mdou_MontoVenta = 0.0;
                        ...
                        mdou_MontoVenta = new Double(importeTotal + importeIgv);
                        ...
                        Log.d(TAG,"Despacho:"+mdou_CantidadDespacho);
    ...
    private void generarVenta() {
        ...
        String scop = " ";
        if(editTextScop.getText().toString() != ""){
            scop = editTextScop.getText().toString();
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.fab:
                ...
                break;
            case R.id.btnVender:
                //validar el escop por la capasidad del cliente
                double mdob_CapAlmCliente = almacenCliente.getCapacidadReal();
                Log.d(TAG, "mdob_CapAlmCliente: " + mdob_CapAlmCliente);
               if(mdob_CapAlmCliente >= 1000){
