...
public class Constants {
    ...
    public static final String FIREBASE_CHILD_UBICACION = "UBICACION ";
    public static final String FIREBASE_CHILD_USUARIO = "USUARIOS";
    public static final String FIREBASE_CHILD_DISPOSITIVOS = "DISPOSITIVOS";
    ...
    public static final int TIPO_ID_DEVICE_IMPRESORA = 4;
    ...
    public static final int COMPROBANTE_CREADO_PAGADO = 24;
    ...
    public static final String SESSION_ENTIDAD_ID = "SESSION_ENTIDAD_ID";
