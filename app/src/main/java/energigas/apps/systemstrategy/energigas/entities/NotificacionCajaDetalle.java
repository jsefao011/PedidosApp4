...
public class NotificacionCajaDetalle {
    ...
    private double CantDespacho;
    private double VentaActual;
    public NotificacionCajaDetalle() {
    }

    public NotificacionCajaDetalle(int establecimientoId, int estadoFacId, int estadoId, String fecha, int liId, int lidId, int ordenAtencion, int peId, double porDespacho, double porEntrega, double porFacturado, double precio, double cantDespacho, double ventaActual) {
    ...
    public double getCantDespacho() {
        return CantDespacho;
    }

    public void setCantDespacho(double cantDespacho) {
        CantDespacho = cantDespacho;
    }
