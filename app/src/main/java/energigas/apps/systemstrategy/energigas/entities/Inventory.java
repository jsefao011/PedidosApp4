...
public class Inventory {
    ...
    public static List<Inventory> getInventoryList(Context context) {
        ...
        double  mdou_SaldoIncial = cajaLiquidacion.getStockInicial();
        for (Producto producto : productoList) {
            ...
            if (producto.getProId() == almacen.getProductoId()) {
                ...
                for (OrdenCargo ordenCargo : OrdenCargo.find(OrdenCargo.class, "liq_Id=?", new String[]{cajaLiquidacion.getLiqId() + ""})) {
                    cantidadOrdenCargo = cantidadOrdenCargo + ordenCargo.getCantidadTransformada();
                }
                double cantidadFinal = mdou_SaldoIncial + (cantidadOrdenCargo - cantidadDespachada);
                Inventory inventory = new Inventory(producto.getNombre(), mdou_SaldoIncial, cantidadDespachada, cantidadFinal, cantidadOrdenCargo, null);
