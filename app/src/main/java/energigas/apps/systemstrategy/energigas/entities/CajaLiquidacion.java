...
public class CajaLiquidacion extends SugarRecord {
    ...
    public static CajaLiquidacion getCajaLiquidacion(String liquidacionId) {
        ...
        if (aBoolean) {
            ...
            Log.d("IDENTIDAD", "" + cajaLiquidacion.getEntidadId());
    ...
    public static CajaLiquidacion getCajaLiquidacionCerrarCaja(String liquidacionId, String latitudFinal, String longitudFinal) {
        ...
        if (aBoolean) {
            ...
            cajaLiquidacion.setLiqId(cajaLiquidacion.getLiqId());
            cajaLiquidacion.setFechaCierre(Utils.getDatePhone());
            cajaLiquidacion.setLatitudFinal(latitudFinal);
            cajaLiquidacion.setLongitudFinal(longitudFinal);
